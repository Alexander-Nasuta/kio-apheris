...
from openhub.data_standalone import raw_data
...
if __name__ == '__main__':
    ...
    steps = [
        ...
        (
            ...
            OneHotEncodePd(
                ...
                sep="_",
                required_columns=[
                    # some datapoints have decimal values for some reason
                    # it would be nicer to merge ausformung_1.0 and ausformung_1
                    # but just cover all possible values here is more comvenient
                    "Ausformung_1",
                    "Ausformung_1.0",
                    "Ausformung_1.5",
                    "Ausformung_2",
    ...
    # Train the model
    model = train_model(df, num_epochs=100, batch_size=32)
